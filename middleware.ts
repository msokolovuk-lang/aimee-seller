...
const PUBLIC_PATHS = ['/login', '/api/auth/login', '/admin', '/admin/finance', '/admin/integrations', '/api/ai-import', '/api/ai-import', '/api/sdk', '/api/connectors', '/api/customers', '/api/agents']
